...
require (
	...
	github.com/johnsonjh/gobcd v0.0.0-20230324103000-b652b9e889eb
...
replace github.com/jonaz/gombus => github.com/yottabytesolutions/gombus v0.0.0-20260426134653-0a30ec79d0a0
